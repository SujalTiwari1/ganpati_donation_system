  ...
  head: () => ({
    meta: [
      ...
      { title: "Vargani CMS — Ganpati Collection Management" },
      {
        name: "description",
        content:
          "Manage Ganpati vargani collections, receipts, buildings and donors with a fast, auditable dashboard.",
      },
      { property: "og:title", content: "Vargani CMS — Ganpati Collection Management" },
      {
        property: "og:description",
        content: "Track donations, issue receipts and monitor collections in real time.",
      },
